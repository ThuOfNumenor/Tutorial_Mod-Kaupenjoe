...
import net.josep.tutorialmod.TutorialMod;
...
public class ModItems {
    ...
    //Adds a new item, with name zircon, and adds it to the Misc. creative tab.  All lowercase, no spaces or special characters.
